...
public class UsersServlet extends HttpServlet {
    ...
    private void showUsers(HttpServletRequest request,
        ...
        RequestDispatcher showUsers = request.getRequestDispatcher("/users.jsp");
        showUsers.forward(request, response);
        // END
    }
    ...
    private void showDeletePage(HttpServletRequest request,
        ...
        // BEGIN
        request.setAttribute("user", user);
        RequestDispatcher delete = request.getRequestDispatcher("/delete.jsp");
